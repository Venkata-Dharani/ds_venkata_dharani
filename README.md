...
## Dataset Access
Due to GitHub file size limitations, the original datasets
are not uploaded to this repository.

They can be accessed from the official sources:
- Fear & Greed Index dataset
- Historical trader data (Hyperliquid)

Please refer to the assignment document for dataset links.
